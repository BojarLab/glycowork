...
```
    ...
    This glycan occurs in the following species: ['Antheraea_pernyi', 'Apis_mellifera', 'Ascaris_suum', 'Autographa_californica_nucleopolyhedrovirus', 'AvianInfluenzaA_Virus', 'Bombyx_mori', 'Bos_taurus', 'Caenorhabditis_elegans', 'Crassostrea_virginica', 'Cricetulus_griseus', 'Dirofilaria_immitis', 'Drosophila_melanogaster', 'Gallus_gallus', 'Glossina_morsitans', 'Haemonchus_contortus', 'Heligmosomoides_polygyrus', 'Homo_sapiens', 'HumanImmunoDeficiency_Virus', 'Lutzomyia_longipalpis', 'Lymantria_dispar', 'Mamestra_brassicae', 'Megathura_crenulata', 'Mus_musculus', 'Nilaparvata_lugens', 'Oesophagostomum_dentatum', 'Ophiactis_savignyi', 'Pristionchus_pacificus', 'Rattus_norvegicus', 'Spodoptera_frugiperda', 'Sus_scrofa', 'Tribolium_castaneum', 'Trichinella_spiralis', 'Trichoplusia_ni', 'Trichuris_suis', 'Volvarina_rubella', 'Schistosoma_mansoni', 'SemlikiForest_Virus', 'Cardicola_forsteri', 'Dictyocaulus_viviparus', 'Haliotis_tuberculata', 'Tick_borne_encephalitis_virus', 'Aedes_aegypti', 'Tropidolaemus_subannulatus', 'Hylesia_metabus', 'undetermined', 'Fasciola_hepatica', 'Angiostrongylus_cantonensis', 'unidentified_influenza_virus', 'Anopheles_gambiae', 'Opisthorchis_viverrini', 'Hydra_vulgaris']
    ...
    This glycan has been reported to be expressed in: ['nerve_terminal', 'alveoli', 'colon', 'ovary', 'placenta', 'liver', 'pancreas', 'milk', 'kidney', 'CHO_K1_cell_line', 'iPS1A_cell_line', 'iPS2A_cell_line', 'A549_cell_line', 'HEK293_cell_line', 'prostate', 'brain', 'cerebellum', 'hippocampus', 'cortex']
    ['benign_breast_tumor_tissues_vs_para_carcinoma_tissues', 'breast_cancer_tissues_vs_benign_breast_tumor_tissues', 'idiopathic_rapid_eye_movement_sleep_behavior_disorder', 'cystic_fibrosis', 'breast_cancer', 'prostate_cancer']
