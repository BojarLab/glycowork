...
monosaccharide_mapping = {
    ...
    'axxxxh-1x_1-5_2*N': 'HexN',

    'u2222h_2*NCC/3=O': 'AllNAc',
    'a2222h-1x_1-5_2*NCC/3=O': 'AllNAc',
    'a2112h-1x_1-5_2*NCC/3=O': 'GalNAc',
    'a2112h-1x_1-?_2*NCC/3=O': 'GalNAc',
    'h2112h_2*NCC/3=O': 'GalNAc-ol',
    'a1221h-1x_1-5_2*NCC/3=O': 'L-GalNAc',
    'a2122h-1x_1-5_2*NCC/3=O': 'GlcNAc',
    'a2122h-1x_1-?_2*NCC/3=O': 'GlcNAc',
    'h2122h_2*NCC/3=O': 'GlcNAc-ol',
    'a1211h-1x_1-5_2*NCC/3=O': 'L-GlcNAc',
    'a2212h-1x_1-5_2*NCC/3=O': 'GulNAc',
    'axxxxh-1x_1-5_2*NCC/3=O': 'HexNAc',
    'axxxxh-1x_1-?_2*NCC/3=O': 'HexNAc',
    'a1122h-1x_1-5_2*NCC/3=O': 'ManNAc',
    'a2122x_2*NCC/3=O': 'QuiNAc',

    'Aad21122h-2x_2-6_5*NCC/3=O': 'Neu5Ac',
    'Aad21122h-2x_2-6_5*N': 'Neu',
    'Aad21122h-2x_2-6_5*NCCO/3=O': 'Neu5Gc',
    'Aad21122h-2x_2-6': 'Kdn',
    'Aad21122h-2x_2-?': 'Kdn',

    'a211h-1x_1-5_4*OSO/3=O/3=O': 'Ara4S',
    'a1212A-1x_1-5_2*OSO/3=O/3=O': 'D-IdoA2S',
    'a2112h-1x_1-5_?*OSO/3=O/3=O': 'GalOS',
    'a2112h-1x_1-5_6*OSO/3=O/3=O': 'Gal6S',
    'a2112h-1x_1-5_4*OSO/3=O/3=O': 'Gal4S',
    'a2112h-1x_1-5_3*OSO/3=O/3=O': 'Gal3S',
    ...
    'a2112h-1x_1-5_2*NCC/3=O_4*OSO/3=O/3=O_6*OSO/3=O/3=O': 'GalNAc4S6S',
    'a2122A-1x_1-5_?*OSO/3=O/3=O': 'GlcAOS',
    'a2122A-1x_1-5_3*OSO/3=O/3=O': 'GlcA3S',
    'a2122h-1x_1-5_2*NCC/3=O_?*OSO/3=O/3=O': 'GlcNAcOS',
    'a2122h-1x_1-5_2*NCC/3=O_6*OSO/3=O/3=O': 'GlcNAc6S',
    'axxxxh-1x_1-5_?*OSO/3=O/3=O': 'HexOS',
    'axxxxh-1x_1-5_3*OSO/3=O/3=O': 'Hex3S',
    ...
    'a2222h-1x_1-5_3*N': 'All3N',
    'ad222m-1x_1-5_3*OC': 'Dig3Me',
    'Aad21122h-2x_2-6_4*OCC/3=O_5*NCC/3=O': 'Neu4Ac5Ac',
    'a2112h-1x_1-5_3*OC': 'Gal3Me',
    'a2112h-1x_1-5_6*OC': 'Gal6Me',
    'a2122h-1x_1-5_2*OCC/3=O': 'Glc2Ac',
    'a2122A-1x_1-5_4*OC': 'GlcA4Me',
    'a2122A-1x_1-5_6*OC': 'GlcA6Me',
    'a2122h-1x_1-5_2*NCC/3=O_3*OCC/3=O': 'GlcNAc3Ac',
    'axxxxh-1x_1-5_2*NCC/3=O_4*OC': 'HexNAc4Me',
    'a1122h-1x_1-5_6*OCC/3=O': 'Man6Ac',
    'a1122h-1x_1-5_3*OC': 'Man3Me',
    'a1122h-1x_1-5_6*PO/2O/2=O': 'Man6P',
    'a2122m-1x_1-5_3*N': 'Qui3N',
    'a2122m-1x_1-5_2*NCC/3=O_4*OCC/3=O': 'QuiNAc4Ac',
    'a2211m-1x_1-5_2*OCC/3=O': 'Rha2Ac',
    'a2211m-1x_1-5_2*OCC/3=O_3*OCC/3=O_4*OCC/3=O': 'Rha2Ac3Ac4Ac',
    'a1122m-1x_1-5_4*NC=O': 'D-Rha4NFo',
    }
